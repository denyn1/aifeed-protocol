...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-271%20JS%20%C2%B7%2045%20Python-3ddc97" alt="测试套件">
...
| [`packages/`](packages/) + [`clients/python/`](clients/python/) | 已发布包：CLI（`aifeed`）、SDK（`@aifeed/verify`）、MCP 服务器、构建插件（`@aifeed/frameworks`）、PyPI 验证器 `aifeed` |
