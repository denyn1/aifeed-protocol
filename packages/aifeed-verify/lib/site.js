...
function buildManifest(options) {
  ...
  if (fs.existsSync(path.join(options.dir, 'sitemap.xml'))) content.sitemap = '/sitemap.xml';
...
module.exports = { buildSite, buildManifest, collectHtmlFiles, pagePathFor, mdPathFor };
