...
```bash
npm test                 # suite tes Node (283 tes: unit, vektor, AIFeed Markdown/MAKO, i18n global, site builder, adapter server, pemilihan triage, enforcement, laporan HTML, kit pilot, fuzz smoke, SDK, CLI, bundel, integrasi, rotasi kunci, server MCP)
...
[`agent-quickstart.md`](agent-quickstart.md); contoh yang bisa dijalankan:
...
[`publisher-ai-guide.md`](publisher-ai-guide.md) — satu track untuk situs
